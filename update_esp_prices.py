...
updates = {
    "Industrial Security": 3799,
    "Surveillance System": 6499,
    "Face Security": 4799,
    "Livestock Monitoring": 6899,
    "Farm Robot": 6999
}
...
for product in data.get('products', []):
    ...
    for keyword, new_price in updates.items():
        if keyword.lower() in name.lower() or ('esp32-cam' in keyword.lower() and 'surveillance' in name.lower()):
    ...
    for file in files:
        if file.endswith('.html'):
            ...
            for name, c in price_changes.items():
                ...
                # Page specifically for this product
