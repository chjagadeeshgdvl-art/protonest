...
updates = {
    "Door Lock System": 19999,
    "Intruder": 27999,
    "Obstacle Avoiding": 29999,
    "Smart Agricultural": 27999
}
...
for product in data.get('products', []):
    ...
    for keyword, new_price in updates.items():
        if keyword.lower() in name.lower() or ('intruder' in keyword.lower() and 'secure' in name.lower()):
    ...
    for file in files:
        if file.endswith('.html'):
            ...
            for name, c in price_changes.items():
                ...
                # Direct Replace
                if keyword.lower() in orig_content.lower() and ('product-' in file or file in ['raspberry.html', 'index.html']):
...
# 4. Update generators
GEN_SCRIPTS = ['update-rpi-page.js', 'generate-pages.js']
