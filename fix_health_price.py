    ...
    for file in files:
        if file.endswith('.html'):
            ...
            for name, c in price_changes.items():
                ...
                # Direct Replace
                if keyword.lower() in orig_content.lower() and ('product-' in file or file in ['arduino.html', 'index.html']):
...
# 4. Update generators just in case
GEN_SCRIPTS = ['generate-arduino-pages.js', 'generate-pages.js']
